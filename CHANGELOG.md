...
* Remove typed-error dependency and directly extend `Error` [Pagan Gazzard]
* Convert to ESM [Pagan Gazzard]
* Switch tsconfig module to Node20 [Pagan Gazzard]
* Update tsconfig target to es2024 [Pagan Gazzard]
* Move `timeout` option to the top level, supporting/requiring newer nodejs [Pagan Gazzard]
